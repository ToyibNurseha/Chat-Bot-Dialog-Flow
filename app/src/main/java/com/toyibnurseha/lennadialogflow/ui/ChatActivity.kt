...
import com.toyibnurseha.lennadialogflow.R
import com.toyibnurseha.lennadialogflow.adapter.AdapterChat
import com.toyibnurseha.lennadialogflow.adapter.AdapterSuggestion
import com.toyibnurseha.lennadialogflow.databinding.ActivityChatBinding
import com.toyibnurseha.lennadialogflow.db.ChatDatabase
import com.toyibnurseha.lennadialogflow.repository.ChatRepository
import com.toyibnurseha.lennadialogflow.utils.Helper
...
class ChatActivity : AppCompatActivity() {
    ...
    private fun initViewModel() {
        val repository = ChatRepository(ChatDatabase(this))
    ...
    private fun initSession() {
        val res: InputStream = resources.openRawResource(R.raw.lenna)
